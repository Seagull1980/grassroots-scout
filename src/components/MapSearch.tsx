...
const MapSearch: React.FC<MapSearchProps> = ({ searchType }) => {
  ...
  const generateTestMapData = (): MapSearchResult[] => {
    const testVacancies: MapSearchResult[] = [
      {
        item: {
          id: 'test-1',
          title: 'Striker Needed - Arsenal Youth FC',
          description: 'We are looking for a talented striker to join our Under 16 team. Great coaching and facilities available.',
          league: 'Premier Youth League',
          ageGroup: 'Under 16',
          position: 'Striker',
          location: 'North London',
          contactInfo: 'coach@arsenalyouth.com',
          status: 'active',
      ...
      },
      {
        item: {
          ...
          description: 'Chelsea Youth looking for a creative midfielder. Join our successful Under 18 squad.',
          league: 'Championship Youth',
          ageGroup: 'Under 18',
          position: 'Midfielder',
          location: 'West London',
          contactInfo: 'recruitment@chelseayouth.com',
          status: 'active',
      ...
      },
      {
        item: {
          id: 'test-3',
          title: 'Goalkeeper Opportunity',
          description: 'Tottenham Youth FC seeking a reliable goalkeeper for our Under 17 team. Excellent development program.',
          league: 'Premier Youth League',
          ageGroup: 'Under 17',
          position: 'Goalkeeper',
          location: 'North London',
          contactInfo: 'youth@tottenham.com',
          status: 'active',
    ...
    const testPlayers: MapSearchResult[] = [
      {
        item: {
          id: 'player-1',
          title: 'Experienced Midfielder Available',
          description: 'Creative midfielder with excellent passing ability. Looking for a competitive team to develop further.',
          preferredLeagues: ['Premier Youth League', 'Championship Youth'],
          ageGroup: 'Under 17',
          positions: ['Central Midfielder', 'Attacking Midfielder'],
          location: 'East London',
          contactInfo: 'alex.thompson@email.com',
          postedBy: '101',
          createdAt: '2024-10-01',
      ...
      },
      {
        item: {
          id: 'player-2',
          title: 'Defensive Player Seeking Team',
          description: 'Strong defender with great leadership qualities. Captain of school team.',
          preferredLeagues: ['County League', 'Youth League'],
          ageGroup: 'Under 16',
    ...
    return [...testVacancies, ...testPlayers];
  };
